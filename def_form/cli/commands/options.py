...
def max_def_length_option(func):
    return click.option(
        '--max-def-length',
        type=int,
        default=None,
        help='Maximum length of function definition'
    )(func)


def max_inline_args_option(func):
    return click.option(
        '--max-inline-args',
        type=int,
        default=None,
        help='Maximum number of inline arguments'
    )(func)


def indent_size_option(func):
    return click.option(
        '--indent-size',
        type=int,
        default=None,
...
def show_skipped_option(func):
    return click.option(
        '--show-skipped',
        is_flag=True,
        default=False,
        help='Show skipped files and directories'
    )(func)
